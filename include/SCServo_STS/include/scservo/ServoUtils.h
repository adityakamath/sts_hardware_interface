 ...
 * @see SMS_STS.cpp for usage examples
 */
 ...
 *
 * This eliminates 13+ instances of duplicate direction encoding logic in SMS_STS.cpp
 */
 ...
 * @param servoInstance Reference to servo object (SMS_STS)
